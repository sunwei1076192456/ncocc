...
<template>
  <div style="margin: 20px;">
    ...
    <!-- 新增运单 -->
    <Modal :mask-closable="false" :visible.sync="newModal" :loading="loading" v-model="newModal" width="750" title="新增装箱单" @on-ok="newOk('wayBillNew')" @on-cancel="cancel()">
      <Form ref="wayBillNew" :model="wayBillNew" :rules="ruleNew" :label-width="80" class="newBillModal">
        ...
        <Row style="margin-bottom: 25px;">
          ...
          <Col span="6"><span style="color:red">*</span>装货人：
        ...
        <Row style="margin-bottom: 25px;">
          <Col span="6"><span style="color:red">*</span>装货点：
        ...
        <Row style="margin-bottom: 25px;">
          ...
          <FormItem prop="loading_goods_addr">
            <textarea v-model="wayBillNew.loading_goods_addr" style="width:500px" :autosize="{minRows: 1,maxRows: 1}"></textarea>
          </FormItem>
          </Col>
        </Row>
        <Row style="margin-bottom: 25px;">
...
export default {
  data() {
    return {
      ...
      ruleNew: {
        customer_id: [
          { type: 'number', required: true, message: '请选择装货人', trigger: 'blur' }
        ],
        shipping_id: [
       ...
       /* demurrage: [
        ...
        handle_point: [
          { type: 'array', required: true, message: '请选择装货点', trigger: 'blur' }
        ],
        /*receive_goods_state: [
  ...
  methods: {
    ...
    initWayBillNew() {
      this.wayBillNew.businesstype_code = 2 //默认装箱;
