...
<template>
	<div style="margin: 20px;">
        ...
        <div>
            <ul>
                <li>
                     <Button type="warning" @click="openCarAuditModal()">车管审核</Button>
                </li>
                <li>
        ...
        <!-- 车管审核页面 -->
        <Modal :mask-closable="false" :visible.sync="auditModal" :loading = "loading" v-model="auditModal" width="600" title="调度审核" @on-ok="audit()" @on-cancel="cancel()">
             <!-- <Form ref="disAuditResult" :model="disAuditResult" :label-width="80" class="disAuditResult"> -->
              <Collapse>
                ...
                <Panel name="handInfo">
                    ...
                    <div slot="content">
                      <Row>
                          <Col span="8">车队：
                          <input v-model="wayBill.transport_name" type="text" class="input" style="width:150px;height:30px;font-weight:bold;font-size:15px" readonly=true />
                          <input v-model="selectedTransportInfo.id" type="text" class="input" style="width:150px;height:30px" hidden="true" />
                          </Col>
                          <Col span="8">车队联系人：
                          <input v-model="wayBill.transport_contact_name" type="text" class="input" style="width:150px;height:30px;font-weight:bold;font-size:15px" readonly=true />
                          </Col>
                          <Col span="8">车队联系电话：
                          <input v-model="wayBill.transport_contact_phone" type="text" class="input" style="width:150px;height:30px;font-weight:bold;font-size:15px" readonly=true />
                          </Col>
            </Row>
                    </div>
                </Panel>
                <Panel name="auditInfo">
                    ...
                    <div slot="content">
                      <Row style="margin-bottom: 25px;">
                        <Col span="12">审核结果：
                          <RadioGroup v-model='disAuditResult.auditResult' style="width: 200px">
                      ...
                      <Row>
                        <Col span="16">审核备注：  
                          <textarea v-model="disAuditResult.auditNote" style="width:500px" :autosize="{minRows: 2,maxRows: 5}"></textarea>
                        </Col>
                      </Row>
                    </div>
                </Panel>
	...
	export default {
        ...
        methods:{
            ...
            initWayBill(){
                ...
                this.wayBill.transport_id=null;
                this.wayBill.transport_name=null;
                this.wayBill.transport_contact_name=null;
                this.wayBill.transport_contact_phone=null;
            },
            wayBillSet(e){
                ...
                this.wayBill.transport_id=e.transport_id;
                this.wayBill.transport_name=e.transport_name;
                this.wayBill.transport_contact_name=e.transport_contact_name;
                this.wayBill.transport_contact_phone=e.transport_contact_phone;
            },
            cancel() {
            ...
            initAuditResult(){
              this.disAuditResult.auditResult=null;
              this.disAuditResult.auditNote=null;
            },
            transportInfoSet(){
                this.axios({
                  method: 'get',
                  url: '/api/BillService/queryOrderTransportRela.do',
                  params: {
                    'orderId':this.groupId[0]
                  }
                }).then((response) => {
                    this.transportInfoList=response.data.extend.transportInfo;
                    console.log(this.transportInfoList);
                }).catch((error) => {
                  this.$Message.error(error);
                });
                ...
                if(this.transportInfoList != null){
                    console.log(this.transportInfoList);
                    this.selectedTransportInfo.id = this.transportInfoList[0].id;
                    this.selectedTransportInfo.name = this.transportInfoList[0].name;
                    this.selectedTransportInfo.contactName = this.transportInfoList[0].contact_name;
                    this.selectedTransportInfo.contactPhone = this.transportInfoList[0].contact_phone;
                }
            },
            audit(){
              if(this.disAuditResult.auditResult==null){
              ...
              this.axios({
                  method: 'post',
                  url: '/api/BillService/carAudit.do',
                  data: {
                    'auditResult':this.disAuditResult.auditResult,
                    'auditNote':this.disAuditResult.auditNote,
                    'orderId':this.groupId[0],
                    'workOrderId':this.groupWorkOrderId[0]
                  }
                }).then((response) => {
